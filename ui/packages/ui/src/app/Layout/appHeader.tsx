...
import BrandLogo from '../../../assets/images/debezium-logo.png'
...
const AppHeader: React.FC = () => {
    ...
    return (
		<PageHeader logo={<Brand className="brandLogo" src={BrandLogo} alt="Debezium" />} headerTools={headerTools} showNavToggle={true} />
    );
}
